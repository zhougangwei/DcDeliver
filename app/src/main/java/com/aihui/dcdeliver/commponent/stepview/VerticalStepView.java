...
public class VerticalStepView extends LinearLayout implements VerticalStepViewIndicator.OnDrawIndicatorListener
{
    ...
    public VerticalStepView setStepViewComplectingTextColor(int ComplectingTextColor)
    {
        mComplectingTextColor = ComplectingTextColor;
        return this;
    }
            ...
            if(mStepBeanList != null && complectedXPosition != null && complectedXPosition.size() > 0)
            {
                for(int i = 0; i < mStepBeanList.size(); i++)
                {
                    ...
                    * */
                    ...
                    RelativeLayout.LayoutParams layoutParams1 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                    ...
                    * */
                    ...
                    mTextTime = new TextView(getContext());
                    mTextTime.setTextSize(TypedValue.COMPLEX_UNIT_SP, mTextSize);
                    mTextTime.setText(mStepBeanList.get(i).getTime());
                    mTextTime.setY(complectedXPosition.get(i) - mStepsViewIndicator.getCircleRadius() / 2);
                    ...
                    mTextTime.setLayoutParams(layoutParams);
                    ...
                    mTextContainer.addView(mTextTime);
                }
            }
        }
    }
