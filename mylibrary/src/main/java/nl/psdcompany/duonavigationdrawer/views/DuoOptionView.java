...
public class DuoOptionView extends RelativeLayout {
     ...
     * By default a little colorPrimary circle in front of the option text.
     *
     ...
     * By default only makes the option text colorPrimary.
     *
     ...
     *                         By default it shows a colorPrimary circle.
     */
